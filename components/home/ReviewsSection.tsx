...
const ReviewsSection: React.FC = () => {
  return (
    <div className="bg-white py-16 px-8 lg:px-32 text-gray-800">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center lg:items-start">
        ...
        <div className="lg:w-1/4 w-full mb-8 lg:mb-0 text-center lg:text-left">
          <h2 className="text-4xl font-extrabold mb-4 text-blue-600">Excellent</h2>
          <div className="flex justify-center lg:justify-start mb-4">
            {/* 5-star rating icons */}
            <div className="flex items-center space-x-1">
              {[...Array(5)].map((_, index) => (
                <svg key={index} className="w-7 h-7 text-yellow-500" fill="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-blue-600 text-sm font-semibold">Trustpilot</p>
        </div>
        ...
        <div className="lg:w-3/4 w-full lg:pl-12">
          <div className="overflow-x-auto flex space-x-6 py-4">
            ...
            {[
              ...
              <div key={review.id} className="bg-gray-100 p-6 rounded-lg shadow-md min-w-[300px]">
                <div className="flex items-center mb-2">
                  {/* 5-star rating icons */}
                  {[...Array(5)].map((_, index) => (
                    <svg key={index} className="w-5 h-5 text-yellow-500 mr-1" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 17.27l5.18 3.73-1.64-5.34L20.36 12h-5.55L12 6.36 9.19 12H3.64l4.82 3.66-1.64 5.34L12 17.27z" />
                    </svg>
                  ))}
                  <span className="ml-2 text-sm text-gray-500">Verified</span>
                </div>
                <p className="text-gray-800 font-semibold mb-1">{review.review}</p>
